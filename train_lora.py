...
from src.lora_trainer import LoRATrainingConfig, train_lora_classification
...
def parse_args():
    ...
    parser.add_argument(
        "--model", type=str, default=None, help="Model name from HuggingFace"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Disable gradient checkpointing (faster on H100 with large VRAM)",
    )
